...
def compress(data):
	...
	while i < len(data):
		...
		#print('(%i,%i)' % (abs(longest_start-i),longest_len) )
		#print(next_byte)
			
		#comp_data += chr(abs(longest_start-i))+chr(longest_len)+next_byte
...
def decompress(data):
	...
	for i in range(0,len(data),3):
		...
		decomp += copy(decomp,start,end)+[(not data[i+2] == b'$')*data[i+2]]
